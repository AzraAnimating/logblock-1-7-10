...
public class Config {
    ...
    public static String url, urlData, user, password;
    ...
    public static void load(LogBlock logblock) throws DataFormatException, IOException {
        ...
        urlData = config.getString("mysql.host") + "-" + config.getInt("mysql.port") + "-" + getStringIncludingInts(config, "mysql.database");
